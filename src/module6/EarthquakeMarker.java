...
//public interface Comparable<EarthquakeMarker> {
//    public int compareTo(EarthquekeMarker marker);
//}
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker other) {
		//Integer this_mag =  (int)this.getMagnitude();
		//Integer other_mag = (int)other.getMagnitude();
		//int result = 0 - this_mag.compareTo(other_mag);
		//return result;
		float diff = this.getMagnitude() - other.getMagnitude();
		if (diff > 0) {
			return -1;
		} else if (diff < 0) {
			return 1;
